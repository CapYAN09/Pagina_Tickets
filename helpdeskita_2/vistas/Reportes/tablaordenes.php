...
// Tu consulta actual puede estar generando duplicados por los JOINs
// Verifica si hay relaciones uno-a-muchos en las tablas

// Solución: Usa DISTINCT o GROUP BY
$sql = "SELECT DISTINCT
