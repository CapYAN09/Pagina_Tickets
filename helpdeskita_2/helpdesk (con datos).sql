...
(2, 'Miguel Ortiz Martines');
(2, 'José de Jesús González Méndez');
...
CREATE TABLE `t_reportes_finalizados` (
  `id_reporte_finalizado` int  AUTO_INCREMENT NOT NULL,
...
CREATE TABLE `cat_Depa` (
  `id_depa` int NOT NULL AUTO_INCREMENT,
  `Nombre_depa` varchar(245) NOT NULL,
  PRIMARY KEY (`id_depa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;